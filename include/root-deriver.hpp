...
{
using RootMemo = std::unordered_map<const WordTreeNode *, ValidDerives>;
};
...
public:
    ...
    /// word in the list returns a tree of all valid paths of complete
    /// WordListNode types
...
private:
    ...
    /// each word in the list returns all linked-lists of the valid paths of
    /// Word types
    ValidDerives recursiveDeriveRoots(const std::shared_ptr<WordTreeNode> &tree,
